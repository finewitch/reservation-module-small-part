...
import { apiUrl, apiProviderToken } from '../config'
...
export const parseSettings = ({
  method = 'get', data, locale = 'pl', ...otherSettings
} = {}) => {
  const headers = {
    Accept: 'application/json',
    'Content-Type': 'application/json',
    'Accept-Language': locale,
    "X-Provider-Token": apiProviderToken,
  }
...
//api.create({headers: {"X-Provider-Token": apiProviderToken}})
export default api
